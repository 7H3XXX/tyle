    ...
    <div role="note" className="border-b border-border bg-muted">
      <div className="mx-auto flex max-w-180 flex-wrap items-center justify-between gap-x-4 gap-y-1 px-5 py-2.5 text-sm sm:px-8">
        <p>
          ...
          <span className="text-muted-foreground"> · les réponses sont enregistrées comme tests</span>
        </p>
        <Link
          href="/admin?data=test"
          className="rounded font-medium underline-offset-4 hover:underline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring"
        >
